...
Menu::Menu(RenderWindow* window)
{
	...
	this->font1.loadFromFile("Font/ZealotOutline.ttf");
	...
	this->menu.setFillColor(Color(0, 215, 215));
	...
	this->menu1.setFillColor(Color(255, 255, 255));
	...
	this->play.setFillColor(Color(51, 51, 255));
	...
	this->score.setFillColor(Color(51, 51, 255));
	...
	this->quit.setFillColor(Color(51, 51, 255));
